    ...
    async def start(self):
        ...
        if config.STRING1:
            try:
                ...
                try:
                    await self.one.join_chat("aboutkanha")
                    await self.one.join_chat("kanhasworld")
        ...
        if config.STRING2:
            try:
                ...
                try:
                    await self.two.join_chat("aboutkanha")
                    await self.two.join_chat("kanhasworld")
                except:
                    pass
        ...
        if config.STRING3:
            try:
                ...
                try:
                    await self.three.join_chat("aboutkanha")
                    await self.three.join_chat("kanhasworld")
                except:
                    pass
        ...
        if config.STRING4:
            try:
                ...
                try:
                    await self.four.join_chat("aboutkanha")
                    await self.four.join_chat("kanhasworld")
                except:
                    pass
        ...
        if config.STRING5:
            try:
                ...
                try:
                    await self.five.join_chat("aboutkanha")
                    await self.five.join_chat("kanhasworld")
                except:
                    pass
