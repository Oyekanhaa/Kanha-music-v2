...
@kanha.on_message(filters.command("auth") & filters.group & ~BANNED_USERS)
@AdminActual
...
@kanha.on_message(filters.command("unauth") & filters.group & ~BANNED_USERS)
@AdminActual
...
async def authusers(client, message: Message, _):
    ...
    if not _wtf:
        ...
        for umm in _wtf:
            ...
            try:
                user = (await kanha.get_users(user_id)).first_name
                j += 1
            except:
                continue
